...
export default ({ mode }: any) => {
  ...
  // Vite config was taken from https://github.com/jphillipsCrestron/ch5-react-ts-template
  // Much is commented out for troubleshooting what the minimum config is
  // Will be refactored and perfected once I get the touchpanel talking to the CP4.
  return defineConfig({
    plugins: [
      react(),
      // viteSingleFile(),
      // viteStaticCopy({
      //   targets: [{ src: 'node_modules/@crestron/ch5-crcomlib/build_bundles/umd/cr-com-lib.js', dest: '' },]
      // }),
      ...
      VitePWA({
        ...
        manifest: {
          ...
          // icons: [{ src: './assets/vite.png', sizes: '800x800', type: 'image/png', } ],
          ...
          // screenshots: [ { src: './assets/screenshot_wide.jpg', sizes: '1024x593', form_factor: 'wide', type: 'image/jpeg' }, { src: './assets/screenshot_narrow.jpg', sizes: '540x720', form_factor: 'narrow', type: 'image/jpeg' } ]
        },
      }),
    ],
    base: './',
